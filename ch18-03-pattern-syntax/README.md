...
## [所有的模式语法](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#所有的模式语法)
...
### [匹配字面值](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#匹配字面值)
...
### [匹配命名变量](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#匹配命名变量)
...
<u>让我们看看当 `match` 语句运行的时候发生了什么。第一个匹配分支的模式并不匹配 `x` 中定义的值，所以代码继续执行。</u>

<u>第二个匹配分支中的模式引入了一个新变量 `y`，它会匹配任何 `Some` 中的值。因为我们在 `match` 表达式的新作用域中，这是一个新变量，而不是开头声明为值 10 的那个 `y`。这个新的 `y` 绑定会匹配任何 `Some` 中的值，在这里是 `x` 中的值。因此这个 `y` 绑定了 `x` 中 `Some` 内部的值。这个值是 5，所以这个分支的表达式将会执行并打印出 `Matched, y = 5`。</u>
...
### [多个模式](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#多个模式)
...
### [通过 `..=` 匹配值的范围](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#通过--匹配值的范围)
...
### [解构并分解值](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#解构并分解值)

也可以使用模式来解构结构体、枚举和元组，以便使用这些值的不同部分。让我们来分别看一看。

#### [解构结构体](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#解构结构体)
...
#### [解构枚举](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#解构枚举)
...
#### [解构嵌套的结构体和枚举](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#解构嵌套的结构体和枚举)
...
#### [解构结构体和元组](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#解构结构体和元组)
...
#### [使用 `_` 忽略整个值](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#使用-_-忽略整个值)
...
#### [使用嵌套的 `_` 忽略部分值](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#使用嵌套的-_-忽略部分值)
...
#### [通过在名字前以一个下划线开头来忽略未使用的变量](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#通过在名字前以一个下划线开头来忽略未使用的变量)
...
#### [用 `..` 忽略剩余值](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#用--忽略剩余值)
...
### [匹配守卫提供的额外条件](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#匹配守卫提供的额外条件)
...
### [`@` 绑定](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#-绑定)
...
## [总结](https://kaisery.github.io/trpl-zh-cn/ch18-03-pattern-syntax.html#总结)
